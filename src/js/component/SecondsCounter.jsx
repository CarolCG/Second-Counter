...
const SecondsCounter = (props) => {
	return (
		<div className="text-center container-fluid">
			...
			<div className="bg-dark text-white m-1" style={{fontSize:"90px", width:"10%"}}><i className="far fa-clock"></i></div>
			<div className="bg-dark text-white m-1" style={{fontSize:"90px", width:"8%"}}>{props.hora2}</div>
